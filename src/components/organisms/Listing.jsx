		...
		<article className='grid grid-cols-1 grid-rows-[120px_500px_20px_80px] gap-8 p-4'>
			...
			<>
				<section className='grid grid-cols-2 grid-rows-3 gap-4'>
					<div className='via-dark to-red-wine bg-gradient-to-r from-transparent p-[2px]'>
						<div className='bg-light h-full w-full p-1'>
					...
					<div className='from-red-wine via-dark bg-gradient-to-r to-transparent p-[2px]'>
						<div className='bg-light h-full w-full p-1'>
				...
				<div className='text-red-wine flex items-center justify-center gap-10'>
